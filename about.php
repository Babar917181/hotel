                ...
                <div class=" navbar" style="margin-left: 40%;">
                  <!-- right text adjutment -->
                    <div class="navbar-nav">
                        ...
                        <a href="about.php" class="nav-link active" style="color:  #ffc107;">About</a>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            ...
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="about-2.jpg" style="margin-top: 25%;">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <h1 class="section-title ff-secondary text-start  fw-normal" style="color: #ffc107;">About Us</h1>
                        <h1 class="mb-4">Welcome to DWF- Don't Waste Food Management</h1>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos erat ipsum et lorem et sit, sed stet lorem sit.</p>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center ">
                                    <h1 class="flex-shrink-0 display-5  mb-0" data-toggle="counter-up" style="color: #ffc107;">15</h1>
                                    <div class="ps-4">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <h1 class="flex-shrink-0 display-5 " data-toggle="counter-up" style="color: #ffc107;">50</h1>
                                    <div class="ps-4">
                        ...
                        <a class="btn btn-warning py-3 px-5 mt-2" href="readmore.php">Read More</a>
                    </div>
                </div>
            </div>
        </div>
