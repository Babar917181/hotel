...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet">
                ...
                <div class=" navbar" style="margin-left: 40%;">
                  <!-- right text adjutment -->
                    <div class="navbar-nav">
                        <a href="home.php" class=" nav-link active   " style="color: #ffc107;">Home</a>
                        ...
                        <a href="contact.html" class="nav-link">Contact</a>
                         <a href="contact.html" class="nav-link">Feedback</a>
                    </div>
 ...
 <div class="container-xxl py-5  bg-dark hero-header">
                <div class="container" style="margin-top: 10%;">
                    <div class="row">
                        <div class="col-lg-6 ">
                            <h1 class="display-5 text-white ">Enjoy Our<br>Delicious Meal</h1>
                            <p class="text-white ">
                            Islamabad has always catered to the foodies in the city in the most perfect way. The eateries in this city have always made sure that everyone gets exactly what they want, be it desi food, fast food, or any other international cuisines.</p>
                            <a href="" class=" btn btn-warning " style="border-radius: 15px;">Book A Table</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="hero.png" style="margin-bottom: 15%;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center ">
                    <h5 class=" text-center text" style="color: #ffc107; font-family: sans-serif;">---- Food Menu ----</h5>
                    <h1 class="" style="padding: 10px;">Most Popular Items</h1>
                </div>
                <div class="container" style="border-bottom: 2px solid whitesmoke;margin-bottom: 50px;">
  <div class="row" style="align-content: center; margin-left: 23%; ">
    <div class="col-sm-3  btn btn-outline-warning" style="border-radius: 30px;">
      <i class="fa fa-coffee fa-2x text" style="color: #ffc107; margin-left: 10px;"></i> 

      <h5><a href="babar.php" style="color: black; text-decoration: none;">Breakfast</a></h5>
    </div>
    <div class="col-sm-3 btn btn-outline-warning" style="border-radius: 30px;">
      <i class="fa fa-hamburger fa-2x text" style="color:#ffc107 ;"></i>
      <h5><a href="lunch.php" style="text-decoration: none; color: black;">Lunch</a></h5>
    </div>
    <div class="col-sm-3 btn btn-outline-warning" style="border-radius: 30px;">
      <i class="fa fa-utensils fa-2x text " style="color: #ffc107;"></i>
      <h5><a href="dinner.php" style="text-decoration: none; color: black;">Dinner</a></h5>
    </div>
  </div>
</div>
